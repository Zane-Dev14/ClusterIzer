...
def test_formula():
    ...
    CATEGORY_MULTIPLIERS = {
        "security": 2.0, "reliability": 1.8, "cost": 0.5, "default": 1.0
    }
    ...
    print(f"1 critical security signal")
    ...
    signals = [{"severity": "critical", "category": "reliability", "message": "test"}] * 20
    score, total, count = compute_score(signals)
    print(f"20 critical reliability signals")
    print(f"  Raw total: {total}, Signal count: {count}")
    print(f"  Score: {score}/100")
    ...
    signals = [{"severity": "medium", "category": "reliability", "message": "test"}] * 30
    score, total, count = compute_score(signals)
    print(f"30 medium reliability signals (SATURATION TEST)")
    print(f"  Raw total: {total}, Signal count: {count}")
    print(f"  Score: {score}/100")
    ...
    signals = [{"severity": "medium", "category": "reliability", "message": "test"}] * 10
    score, total, count = compute_score(signals)
    print(f"10 medium reliability signals")
    print(f"  Raw total: {total}, Signal count: {count}")
    print(f"  Score: {score}/100")
    print(f"  ✓ OK\n")
