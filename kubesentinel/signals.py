...
def _generate_statefulset_signals(snapshot: Dict[str, Any], seen: Set, signals: List) -> None:
...
def _generate_daemonset_signals(snapshot: Dict[str, Any], seen: Set, signals: List) -> None:
...
def _generate_namespace_signals(snapshot: Dict[str, Any], seen: Set, signals: List) -> None:
...
def _generate_node_signals(snapshot: Dict[str, Any], seen: Set, signals: List) -> None:
    ...
    for node in nodes:
        ...
        if conditions.get("Ready") is False:
            _add_signal(signals, seen, "reliability", "critical", resource,
...
def _generate_orphan_workload_signals(snapshot: Dict[str, Any], graph_summary: Dict[str, Any], seen: Set, signals: List) -> None:
