...
class TestCRDDiscovery:
    ...
    def test_discover_crds_empty_cluster(self):
        ...
        with patch("kubesentinel.crd_discovery.client.CustomObjectsApi") as mock_api_class:
            mock_api = MagicMock()
    ...
    def test_discover_crds_handles_api_exception(self):
        ...
        with patch("kubesentinel.crd_discovery.client.CustomObjectsApi") as mock_api_class:
            ...
            mock_api.list_cluster_custom_object.side_effect = ApiException(status=404, reason="Not Found")
